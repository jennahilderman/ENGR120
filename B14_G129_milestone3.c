...
#pragma config(Sensor, dgtl9,  batInput,       sensorSONAR_cm)
...
t_position position = started;
t_claw claw = starting;
...
void lightLED(){
    ...
    else if(SensorValue(batInput) <= justRight && SensorValue[infraFrontL] <= IR_SENSOR_THRESHOLD ){
